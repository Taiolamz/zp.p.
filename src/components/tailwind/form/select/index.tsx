...
const ZojaSelect = ({ id, name = '', options, touched = {}, disabled, showArrown = false, arrowDownClass, label, error, marginTop, extraClass, onChange, icon, labelExtraClass, setSelectedOption }: SelectProps) => {
    return (
        <div className={marginTop}>
            ...
            <div className="tw-relative tw-w-fit">
                <select
                    ...
                    className={`${extraClass} tw-border tw-border-gray-300 tw-text-gray-900 tw-text-sm tw-rounded-lg tw-focus:ring-blue-500 tw-focus:border-blue-500 tw-block tw-p-2.5
                focus:tw-outline-none ${touched[name] && error ? 'tw-border-red-400' : ''} ${disabled && 'tw-bg-gray-300'}`}>
                    {
