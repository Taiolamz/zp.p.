...
const AllUserStat = ({total_user, active_user, inactive_user, ios_download, android_download, conversion_rate}: IProps) => {
    return (
        <div className='tw-bg-white tw-p-4 tw-rounded-md tw-shadow-zojaShadowOne md:tw-w-[18rem]'>
            <div className='tw-flex tw-justify-between tw-mx-6 md:tw-mx-0'>
                ...
                <div className='tw-flex tw-gap-x-6 md:tw-gap-x-0 md:tw-flex-col'>
                    <StatLabel title='ACTIVE' total={active_user} titleStyle='tw-text-[#009968] tw-text-xs' extraClass='md:tw-items-start '/>
                    <StatLabel title='INACTIVE' total={inactive_user} titleStyle='tw-text-[#FF0000] tw-text-xs' extraClass='md:tw-items-start'/>
                </div>
            </div>
            <div className='tw-bg-[#FAFAFA] tw-rounded-lg tw-cursor-pointer tw-transition-all tw-duration-500 tw-ease-in-out tw-pt-2 tw-px-6 tw-mt-3 md:tw-px-3 hover:tw-shadow-zojaShadowSix'>
